  ...
  <div class="container">
    <div class="row align-items-center justify-content-center">
      <div class="col-md-12">
        ...
        <form method="POST" action="{{ route('search')}}" class="search-jobs-form" enctype="multipart/form-data">
          @csrf
          <div class="row mb-5">
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <input type="text" class="form-control form-control-lg" name="job_title" placeholder="Job title, Company...">
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <select class="selectpicker" data-style="btn-white btn-lg" data-width="100%" data-live-search="true" name="job_region" title="Select Region">
                @foreach($jobRegions as $key => $jobRegion)
                <option value="{{$jobRegion}}">{{$jobRegion}}</option>
                @endforeach
              </select>
            </div>
            <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
              <select class="selectpicker" data-style="btn-white btn-lg" data-width="100%" data-live-search="true" name="job_type" title="Select Job Type">
          ...
          <div class="row">
            <div class="col-md-12 popular-keywords">
              ...
              <ul class="keywords list-unstyled m-0 p-0">
                ...
                <li><a href="#" class="">{{$duplicate}}</a></li>
                @endforeach
              </ul>
            </div>
          </div>
